...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="probootstrap-slider-text text-center">
                                ...
                                <h1 class="probootstrap-heading probootstrap-animate">Rooms</h1>
                                <div class="probootstrap-animate probootstrap-sub-wrap">Ruangan Ruangan Terbaik Yang Kami Punya</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="probootstrap-section">
        <div class="container">
            ...
            <div class="row">
                <!-- Looping data dari RDF -->
                <?php for ($i = 0; $i < count($type); $i++) : ?>
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="probootstrap-room">
                            <a href="room.php/kamar=<?= $i; ?>"><img src="<?= $image[$i]; ?>" alt="Free Bootstrap Template by uicookies.com" class="img-responsive"></a>
                            <div class="text">
                                <h3><?= $type[$i]; ?></h3>
                                <div class="post-meta mb30">
                                    <ul>
                                        <li><span class="review-rate"><?= $review[$i]; ?>/5.0 <i class="icon-star"></i><?= $reviewer[$i]; ?> REVIEWS</li>
                                        <li><i class="icon-user2"></i><?= $guest[$i]; ?> guest</li>
                                    </ul>
                                </div>
                                <p><a href="room.php?kamar=<?= $i; ?>" class="btn btn-primary" role="button">Mulai Dari <?= $price[$i]; ?></a></p>
                            </div>
                        </div>
                    </div>
                <?php endfor; ?>
